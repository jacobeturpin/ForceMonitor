...
public class Monitor extends PApplet {
	 ...
	 * 
	 * 
	 * THIS IS FOR THE PURPOSE OF CREATING A MORE POLISHED DISPLAY FOR THE END
	 * USE OF THE PRODUCT
	 */
	...
	public void setup() {
		...
		// Loop creates the rectable below the header with Yellow-Red gradient
	...
	public void saveData() {
		...
		saveTable(table, "C:/Users/jeturpin/Desktop/" + fileName + ".csv"); // Change
																			// to
																			// save
																			// to
																			// C:\Users\jeturpin\Desktop
	...
	public void controlEvent(ControlEvent theEvent) {
		...
		if (theEvent.isController()) {
			if (theEvent.controller().name() == "Collect") {
				addData();
			}
